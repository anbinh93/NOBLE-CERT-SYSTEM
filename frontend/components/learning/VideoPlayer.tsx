...
export const VideoPlayer = ({
  ...
  return (
    <div
      ref={containerRef}
      className="bg-black overflow-hidden rounded-[24px] border border-primary/20 shadow-[0_4px_20px_-5px_rgba(212,175,55,0.2)] select-none"
    ...
    >
      <div className="aspect-video relative bg-black">
        ...
        {/* ── End-screen overlay ────────────────────────────────────── */}
        {hasEnded && (
          <div className="absolute inset-0 z-[20] bg-black/85 backdrop-blur-sm flex flex-col items-center justify-center gap-5">
