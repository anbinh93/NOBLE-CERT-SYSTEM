    ...
    <div className="space-y-8 pb-20 relative">
      ...
      <div>
         {!certificates || certificates.length === 0 ? (
             (pendingCertificates.length === 0 ? (
                <div className="text-center py-20 bg-card rounded-[24px] border border-primary/10 border-dashed">
             ...
             <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                 {certificates.map((cert: any) => (
                     <div key={cert._id} className="group bg-card rounded-[24px] p-6 shadow-sm border border-primary/10 hover:shadow-[0_10px_30px_-5px_rgba(212,175,55,0.15)] hover:border-primary/30 transition-all duration-300">
                         {/* Card Header */}
