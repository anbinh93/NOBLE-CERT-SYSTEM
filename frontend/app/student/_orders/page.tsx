    ...
    <div className="space-y-8 pb-20 max-w-5xl mx-auto">
      ...
      {transactions.length === 0 ? (
          ...
          <div className="space-y-4">
              {transactions.map((tx) => (
                  <div key={tx.id} className="group bg-card rounded-[24px] p-6 shadow-sm border border-border hover:shadow-md transition-all flex flex-col md:flex-row md:items-center gap-6">
                      {/* Icon / Thumb */}
                      ...
                      {/* Amount & Actions */}
                      <div className="flex flex-row md:flex-col items-center md:items-end gap-4 md:gap-1 mt-4 md:mt-0 border-t md:border-t-0 border-gray-100 pt-4 md:pt-0">
                          <p className="text-xl font-bold text-slate-900">{tx.amount > 0 ? formatCurrency(tx.amount) : "Free"}</p>
