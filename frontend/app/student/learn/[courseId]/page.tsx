  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        {/* Back Nav */}
        <div>
            <Link href="/student/learning" className="inline-flex items-center gap-2 text-sm font-medium text-muted-foreground hover:text-primary transition-colors px-4 py-2 hover:bg-white rounded-full">
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className={`font-medium text-base truncate ${isDone ? "text-muted-foreground line-through" : isLocked ? "text-slate-400" : "text-foreground group-hover:text-primary"}`}>
                                                        {unit.title}
                                                    </p>
                                                ...
                                                <div className={`opacity-0 ${!isLocked && "group-hover:opacity-100"} transition-opacity`}>
                                                     <Button 
                                                        size="sm" 
                                                        variant="ghost" 
                                                        className="rounded-full h-9 px-4 text-xs font-bold bg-white/50 hover:bg-white text-primary border border-primary/20"
                                                        disabled={isLocked}
                                                     >
                           ...
                           return (
                               <Link 
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className={`font-medium text-base truncate ${isExamLocked ? "text-slate-400" : "text-foreground group-hover:text-primary"}`}>
                ...
                <div className="bg-card rounded-[24px] border border-primary/10 p-8 shadow-sm">
                    ...
                    {isCertified ? (
                        <Link href={certificateSerial ? `/verify/${certificateSerial}` : `/student/certificates/claim/${courseId}`} className="block w-full" target={certificateSerial ? "_blank" : "_self"}>
                            <Button className="w-full rounded-full py-6 font-bold bg-green-600 hover:bg-green-700 text-white shadow-lg shadow-green-200" size="lg">
