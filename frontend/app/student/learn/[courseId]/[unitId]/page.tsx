            ...
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                {activeUnit.type === "VIDEO" ? (
                    <div>
                        {isClient && activeUnit.contentUrl ? (
                            ...
                            <div className="aspect-video bg-black rounded-[24px] border border-primary/20 flex items-center justify-center text-white/50 text-sm">
                    ...
                    <div className="bg-card border border-primary/10 rounded-[24px] p-12 min-h-[400px] flex flex-col items-center justify-center text-center shadow-[0_4px_20px_-5px_rgba(212,175,55,0.1)]">
                        ...
                        <a href={activeUnit.contentUrl} target="_blank" className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-primary-foreground shadow-[0_4px_15px_-3px_rgba(212,175,55,0.4)] rounded-full text-base font-bold hover:bg-primary/90 hover:-translate-y-1 transition-all">
                ...
                <div className="flex items-center justify-between pt-8 border-t border-primary/10 mt-12 pb-20">
                     ...
                     <div className="flex gap-4">
                         <Button 
                            variant="outline"
                            className={`px-6 border-primary/10 rounded-full ${completedUnits.includes(activeUnit._id || "") ? "text-green-600 dark:text-green-400 border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-950/30" : "text-muted-foreground hover:text-foreground hover:border-primary/30"}`}
