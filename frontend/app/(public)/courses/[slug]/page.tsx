        ...
        <div className="container mx-auto px-4">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
               ...
               {/* Hero Image */}
               <div className="hidden lg:block relative rounded-[32px] overflow-hidden shadow-[0_20px_50px_-10px_rgba(212,175,55,0.3)] border border-primary/20 transform rotate-1 hover:rotate-0 transition-transform duration-700 bg-black">
                 ...
                 <div className="sticky top-24 space-y-8">
                     ...
                     <div className="bg-card rounded-[32px] p-8 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] border border-primary/20 relative overflow-hidden">
                         ...
                         <div className="aspect-video relative rounded-2xl overflow-hidden bg-muted mb-6 lg:hidden shadow-inner">
                             <Image src={course.thumbnail || "/placeholder-course.jpg"} alt={course.name} fill className="object-cover" />
                         </div>
