            ...
            <main className="flex-1 flex items-center justify-center p-6">
                <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-0 bg-card rounded-2xl shadow-xl border border-border overflow-hidden">
                    ...
                    <div className="p-8 flex flex-col">
                        <div className="mb-8">
                             <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-bold ${error ? "bg-destructive/10 text-destructive" : "bg-primary/10 text-primary"}`}>
