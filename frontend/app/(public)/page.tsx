  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/30 selection:text-primary-foreground">
           ...
           <div className="flex flex-col lg:flex-row items-center gap-16">
               ...
               <div className="flex-1 text-center lg:text-left">
                   ...
                   <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
                       <Link href="/courses">
                           <Button size="lg" className="h-14 px-8 rounded-full text-lg bg-primary text-primary-foreground hover:bg-amber-400 shadow-[0_0_20px_rgba(212,175,55,0.3)] hover:-translate-y-1 transition-all duration-300 font-bold">
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-950 relative overflow-hidden transition-colors duration-300">
          ...
          <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-amber-100/40 dark:bg-amber-900/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/3 pointer-events-none"></div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
               <div className="grid lg:grid-cols-2 gap-16 items-center">
                   ...
                   <div className="max-w-xl">
                       <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white dark:bg-slate-900 border border-primary/20 text-primary text-sm font-bold mb-6 shadow-sm">
                            <span className="w-2 h-2 rounded-full bg-primary animate-pulse"></span>
                            GIÁ TRỊ CỐT LÕI
                       </div>
                       <h2 className="text-3xl md:text-5xl font-serif font-bold text-slate-900 dark:text-slate-50 mb-6 leading-tight">
                           Tại sao chọn <br/>
                   ...
                   <div className="grid sm:grid-cols-2 gap-6">
                       {(
                           ...
                           <div key={i} className="group relative bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-8 rounded-3xl shadow-sm dark:shadow-none hover:shadow-[0_8px_30px_rgba(212,175,55,0.15)] hover:border-primary/30 dark:hover:border-primary/30 transition-all duration-300 hover:-translate-y-1">
                               <item.Icon className="absolute top-4 right-4 w-16 h-16 opacity-5 group-hover:opacity-10 transition-opacity text-primary" />
                               <div className="w-12 h-12 rounded-2xl bg-amber-50 dark:bg-amber-950/30 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                                   <item.Icon className="w-6 h-6 text-primary" />
                               </div>
                               <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50 mb-2 group-hover:text-primary transition-colors">{item.title}</h3>
