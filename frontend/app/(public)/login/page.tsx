...
export default function LoginPage() {
  ...
  return (
    <AuthLayout title="Đăng nhập" subtitle="Chào mừng bạn quay trở lại!" isLogin>
      <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
             ...
             <div className="space-y-1.5">
                 <div className="flex justify-between items-center">
                    ...
                    <Link href="#" className="text-xs font-semibold text-primary hover:text-primary/80 hover:underline">Quên mật khẩu?</Link>
                 </div>
                 <input 
                    name="password"
                    type="password" 
        ...
        <p className="text-center text-muted-foreground text-sm">
            Chưa có tài khoản? <Link href="/signup" className="text-primary font-semibold hover:underline">Đăng ký ngay</Link>
        </p>
      </div>
    </AuthLayout>
  );
