           ...
           <div className="p-10 flex flex-col items-center">
               ...
               {status === "PENDING" ? (
                   <>
                       ...
                       <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-200 mb-8 relative group">
                            <div className="h-48 w-48 bg-slate-900 flex items-center justify-center text-white rounded-lg">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center bg-white/80 opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm rounded-2xl">
                                <span className="text-xs font-mono font-bold text-slate-900">VIETQR DYNAMIC</span>
                            </div>
                       </div>
