...
export default function NewPostPage() {
  ...
  async function handleSave(publish?: boolean) {
    ...
    setSaving(true);
    try {
      const post = await adminFetch<{ id: string }>("/posts", {
        method: "POST",
        body: JSON.stringify({
          title: title.trim(),
          slug: slug.trim(),
      ...
      toast.success(publish ? "Đã tạo và xuất bản bài viết!" : "Đã lưu bản nháp!");
      router.push("/posts");
    } catch (e: any) {
      toast.error(e.message || "Lỗi khi tạo bài viết");
    } finally {
      setSaving(false);
    }
  }
    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight">Tạo bài viết mới</h1>
            <p className="text-sm text-muted-foreground">Viết và xuất bản nội dung lên Blog</p>
          </div>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">Tự động tạo từ tiêu đề, chỉ chứa chữ thường, số và dấu gạch ngang</p>
              </div>
              <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">
                    {isPublished ? "Bài viết sẽ công khai" : "Lưu dưới dạng bản nháp"}
                  </p>
                </div>
