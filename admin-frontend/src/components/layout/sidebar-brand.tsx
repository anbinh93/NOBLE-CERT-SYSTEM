...
const ROLE_BADGE_STYLES: Record<Role, string> = {
  ...
  Instructor: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-400',
  Support: 'bg-amber-100 text-amber-700 dark:bg-amber-950/40 dark:text-amber-400',
};
